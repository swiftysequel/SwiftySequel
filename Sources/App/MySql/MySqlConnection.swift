...
internal class MySqlConnection {
    ...
    internal struct ServerInfo {
        ...
        internal let versionNumber: String
    }

    internal struct MySqlError {
    ...
    internal private(set) var serverInfo: ServerInfo?
    internal private(set) var selectedDatabase: String?
    ...
    internal func listDatabases(wildcard: String? = nil) -> [String] {
        self.fetchStringColumn { mysql_list_dbs($0, wildcard) }
    }

    internal func selectDatabase(named databaseName: String) throws {
    ...
    internal func listTables(wildcard: String? = nil) -> [String] {
    ...
    internal func query(_ statement: String) throws {
    ...
    internal func nextResult() throws -> Int {
        try self.performIfConnected { Int(mysql_next_result($0)) }
    }

    internal func lastInsertId() throws -> Int64 {
        try self.performIfConnected { Int64(mysql_insert_id($0)) }
    }

    internal func numberOfAffectedRows() throws -> Int64 {
