...
internal protocol DependencyInjectionComponent {
...
internal protocol ContainerInitializableComponent: DependencyInjectionComponent {
...
internal struct DependencyInjectionComponentIdentifier: RawRepresentable {
...
internal protocol DependencyInjectionContainer {
...
internal protocol ContainerAwareViewController where Self: NSViewController {
...
extension DependencyInjectionContainer {
    ...
    /// - Throws: An exception if the resulting identifier is already registered with the receiving container.
    internal func register<T>(_ component: T) throws where T: DependencyInjectionComponent {
    ...
    /// - Returns: The component of the passed type and optionally registered by the passed `identifier`.
    internal func get<T>(_ type: T.Type) -> T {
    ...
    internal func createViewController<T>(_ type: T.Type) -> T where T: ContainerAwareViewController {
        return T(container: self)
    }
}

internal class NestedDependencyInjectionContainer: DependencyInjectionContainer {
    internal enum ComponentError: Error {
    ...
    internal init(parentContainer: DependencyInjectionContainer? = nil) {
    ...
    internal func get<T>(_ type: T.Type, registeredAs identifier: DependencyInjectionComponentIdentifier?) -> T {
